...
void
put_str(BITMAP *map, register int x, int y, struct font *font, int op, register const char *str)
   {
...
int
menu_destroy(struct menu_state *state)
   {
   register int i;
...
struct menu_state *
menu_copy(register struct menu_state *menu)
   {
